...
func PruneHistoryToFit(budget ContextBudget, systemPrompt string, history []llm.ChatMessage, userPrompt string, userImageCount int, tools []llm.Tool) ([]llm.ChatMessage, PromptPruneResult) {
...
func EstimatePromptTokens(systemPrompt string, history []llm.ChatMessage, userPrompt string, userImageCount int, tools []llm.Tool) int {
