...
func TestSafeTextRedactsSensitiveValues(t *testing.T) {
	got := SafeText("token=abc123 email me@example.com http://user:pass@example.com/path?api_key=secret /home/alice/file 192.168.1.2 Bearer deadbeef")
	for _, forbidden := range []string{"abc123", "me@example.com", "user:pass", "secret", "/home/alice", "192.168.1.2", "deadbeef"} {
