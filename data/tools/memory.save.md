...
| supersedes | string  | no       | Exact older statement this memory replaces. If the evidence does not name that exact old statement, the server asks the user to confirm the replacement.    |
